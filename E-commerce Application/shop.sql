...
--
INSERT IGNORE INTO `categories` (`Name`, `Description`, `parent`, `Ordering`, `Visibility`, `Allow_Comment`, `Allow_Ads`) VALUES
('Accessoires', 'Mobile and PC Accessories', 0, 1, 0, 0, 0),
('PC Desktop', NULL, 0, 1, 0, 0, 0),
('PC Portable', NULL, 0, 1, 0, 0, 0),
('Smartphones', NULL, 0, 1, 0, 0, 0),
('Others', NULL, 0, 1, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  CONSTRAINT `fk_comment_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_items_comment` FOREIGN KEY (`item_id`) REFERENCES `items` (`Item_ID`) ON DELETE CASCADE ON UPDATE CASCADE
